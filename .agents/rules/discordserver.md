...
## 2. Evolutionary Role Hierarchy (Natural Selection)

### 👑 Vanguard (Tastemakers & Council)
* **Color**: Rich Gold (`#E5A93C`)
* **Role**: Peer-acknowledged creative directors, senior arbiters of taste, and lead mentors.
* **Selection**: Elevated by community consensus + high-tier portfolio drops. Oversees the curation of pieces that get featured on `dawosti.com`.
* **Influence**: Their endorsements carry maximum weight in evolutionary promotions.

### 🏛️ Couturier (Verified Creators & Designers)
* **Color**: Velvet Burgundy (`#8A1C2E`)
* **Role**: Active designers, pattern-makers, stylists, and 3D fashion creators with proven output.
* **Selection**: Earned by submitting verified original fashion designs, physical collections, or lookbooks in `#design-submissions` that meet the quality bar.

### ✂️ Artisan (Stylists & Curators)
* **Color**: Emerald Jade (`#1B7F5E`)
* **Role**: Consistent contributors of high-signal runway analysis, aesthetic critique, and garment construction knowledge.
* **Selection**: Evolutionary upgrade when a member receives sustained positive endorsements on design feedback and moodboard curation.

### 🪡 Atelier (Initiates & Explorers)
* **Color**: Warm Ivory / Slate (`#D4C5B9`)
* **Role**: Entry point for all fashion enthusiasts, observers, and aspiring creators.

---

## 3. Server Architecture (Channel Hierarchy)
...
🏛️ ── ATELIER (CRAFT & CRITIQUE) ──
  ...
  ├── #peer-critique           (Constructive reviews on silhouette, fit, fabric, and story)
  └── #heritage-and-textile    (Nepali Dhaka, Himalayan hemp, ethical sourcing, Newari craft)

👁️ ── THE SALON (AESTHETICS & INSPIRATION) ──
  ├── #streetwear-and-avant-garde (Subcultures, youth style, Kathmandu street culture)
